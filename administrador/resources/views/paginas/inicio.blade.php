              ...
              <div class="row">
                ...
                <div class="col-md-6">
                  <div class="card card-warning">
                    ...
                    <form method="POST" action="{{url('/')}}/usuarios/perfil/{{Auth::user()->id}}" enctype="multipart/form-data">
                      @method('PUT')
                      @csrf
                      ...
                      <div class="card-body">
                        <div class="form-group">
                          ...
                          <label>Para tener una mayor seguridad en el manejo de la información se recomienda cambiar la contraseña generica por una que solo pueda saber usted.</label>
                          <p>No recomendamos el intercambio de contraseñas, las acciones generadas con su usuario correrán bajo su responsabilidad. Para generar con facilmente una contraseña valida puede consultar el instructivo de creación de contraseñas ubicado en la parte inferior del formulario.</p>
                        </div>
                        <div class="form-group">
                          <div class="row">
                            <div class="col-md-12">
                              <input type="password" class="form-control" name="password_1" placeholder="Ingrese nueva contraseña" required>
                            </div>
                          </div>
                        </div>
                        <div class="form-group">
                          <div class="row">
                            <div class="col-md-12">
                              <input type="password" class="form-control" name="password_2" placeholder="Confirme la nueva contraseña" required>
                            </div>
                          </div>
                        </div>
