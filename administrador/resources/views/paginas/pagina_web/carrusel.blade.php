                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group my-2 text-center">
                    <div class="btn btn-default btn-file mb-3">
                      ...
                      <input type="hidden" name="logo_pestana_actual" value="{{url('/')}}/vistas/{{$element->logo_pestana}}" required>
                    </div>
                    <br>
                ...
                <div class="col-md-6">
                  ...
                  <div class="form-group my-2 text-center">
                    <div class="btn btn-default btn-file mb-3">
                      ...
                      <input type="hidden" name="logo_navegacion_actual" value="{{url('/')}}/vistas/{{$element->logo_navegacion}}" required>
                    </div>
                    <br>
