...
<div class="content-wrapper" style="min-height: 243px;">
    ...
    <section class="content">
      <div class="container-fluid">
        ...
        <input type="hidden" name="totalCitasAfiliados" id="totalCitasAfiliados" value="{{$total_citas_afiliados}}">
        <input type="hidden" id="citas_interesados" name="citas_interesados" value="{{$citas_interesados}}">
        <input type="hidden" name="totalCitasInteresados" id="totalCitasInteresados" value="{{$total_citas_interesados}}">
          ...
          <div class="modal-dialog modal-lg">
            <div class="modal-content">
              ...
              <div class="modal-footer col-md-12 justify-content-between">
                ...
                @endphp
                <button type="button" class="btn btn-primary col-md-3" data-toggle="modal" data-target="#editarCita">Editar</button>
              </div>
            </div>
            <!-- /.modal-content -->
          </div>
        ...
        <div class="modal" id="editarCita">
          <div class="modal-dialog modal-xl">
            <div class="modal-content">
              ...
              <form action="{{url('/')}}/citas/general/{{$value["id"]}}" method="post" enctype="multipart/form-data">
                @method('PUT')
                @csrf
                <div class="modal-body">
                  <div class="form-group">
                    @if ($value["tipo_usuario_cita"] == "afiliado")
                      <div class="row">
                        <div class="col-md-6">
                          <input type="hidden" id="soy_afiliado" name="soy_afiliado" value="true">
                          <input type="hidden" id="id_empresa" name="id_empresa" value="{{$value["id_empresa"]}}">
                          <label>NIT</label>
                          <input type="text" class="form-control" id="nit" name="nit" value="{{$value["nit_empresa"]}}" readonly>
                        </div>
                        <div class="col-md-6">
                          <label>Razon social</label>
                          <input type="text" class="form-control" id="razon_social" name="razon_social" value="{{$value["razon_social"]}}" readonly>
                        </div>
                      </div>
                      <div class="row">
                        <div class="col-md-6">
                          <label>Identificación afiliado</label>
                          <input type="text" class="form-control" id="identificacion" name="identificacion" value="{{$value["cc_rprt_legal"]}}" readonly>
                        </div>
                        <div class="col-md-6">
                          @php
                          ...
                          @endphp
                          <label>Afiliado</label>
                          <input type="text" class="form-control" id="afiliado" name="afiliado" value="{{$nombre}}" readonly>
                        </div>
                      </div>
                    @endif
                    @if ($value["tipo_usuario_cita"] == "interesado")
                      <input type="hidden" id="soy_interesado" name="soy_interesado" value="true">
                      <div class="row">
                        <div class="col-md-6">
                          <label>Identificación</label>
                          <input type="number" class="form-control" id="identificacion" name="identificacion" value="{{$value["cc_interesado"]}}">
                        </div>
                        <div class="col-md-6">
                          <label>Nombres y apellidos</label>
                          <input type="text" class="form-control" id="nombres" name="nombres" value="{{$value["nombre_interesado"]}}">
                        </div>
                      </div>
                    @endif
                    <div class="row">
                      <div class="col-md-6">
                        <label>Fecha</label>
                        <input type="date" class="form-control" id="fecha" name="fecha" value="{{$value["fecha_cita"]}}" required>
                      </div>
                      <div class="col-md-6">
                        <label>Hora</label>
                        <input type="time" class="form-control" id="hora" name="hora" value="{{$value["hora_cita"]}}" required>
                      </div>
                    </div>
                    <div class="row">
                      <div class="col-md-6">
                      ...
                      <div class="col-md-6">
                        ...
                        <select class="form-control" id="estado" name="estado" required>
                          <option value="{{$value["estado_cita"]}}">{{$value["estado_cita"]}}</option>
                ...
                <div class="modal-footer col-md-12 justify-content-between">
                  <button id="cerrar" type="button" class="btn btn-default col-md-3" data-dismiss="modal">Cerrar</button>
                  <button id="guardar" type="submit" class="btn btn-warning col-md-3">Guardar</button>
                </div>
              </form>
            </div>
            <!-- /.modal-content -->
