...
class EmpleadosTest extends TestCase
{
    ...
    public function listar_empleados(){
        //prêt
        factory(EmpleadosModel::class, 3)->create();
        factory(GeneroModel::class, 2)->create();
        factory(TipoDocumentoModel::class)->create();
    ...
    public function ingresar_empleado(){
        $tipo_documento = factory(TipoDocumentoModel::class)->create();
        factory(RolesModel::class, 3)->create();
    ...
    public function actualizar_empleado(){
        //prêt
        $tipo_documento = factory(TipoDocumentoModel::class)->create();
        $genero = factory(GeneroModel::class)->create();
