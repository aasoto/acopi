...
class PaginaWebTest extends TestCase
{
    ...
    public function consultar_categorias_noticias(){
        factory(CategoriasModel::class, 3)->create();
        factory(NoticiasModel::class, 3)->create();
    ...
    public function mostrar_una_noticia(){
        ...
        factory(NoticiasModel::class, 2)->create();
    ...
    public function listar_interesados(){
        factory(InteresadoModel::class, 10)->create();
    ...
    public function mostrar_un_interesado(){
        $interesado = factory(InteresadoModel::class)->create();
        factory(InteresadoModel::class, 4)->create();
    ...
    public function eliminar_interesado_de_listado(){
        factory(InteresadoModel::class, 3)->create();
