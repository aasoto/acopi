...
class EntrevistasTest extends TestCase
{
    ...
    public function listado_entrevistas(){
        factory(EntrevistasModel::class, 3)->create();
    ...
    public function listar_una_entrevista(){
        $entrevista = factory(EntrevistasModel::class)->create();
        ...
        //$response->assertViewHas("entrevista", $entrevista);
    ...
    public function eliminar_entrevista_de_listado(){
        $entrevista = factory(EntrevistasModel::class, 3)->create();
