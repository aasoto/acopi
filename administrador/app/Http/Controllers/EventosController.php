			...
			if(!empty($datos)){
	    		...
	    		if($validar->fails()){
	    			...
	    			if (!empty($datos["ponentes"])) {
	    				...
	    				if($validar->fails()){
	    					echo '<pre>'; print_r("ponentes"); echo '</pre>';
	    				return;
	    					return redirect("/eventos/general")->with("no-validacion-2", "");
	    				}
	    			}
	    			if (!empty($datos["patrocinadores"])) {
	    				...
	    				if($validar->fails()){
	    					echo '<pre>'; print_r("patrocinadores"); echo '</pre>';
	    				return;
	    					return redirect("/eventos/general")->with("no-validacion-2", "");
	    				}
	    			}
	    			if (!empty($datos["num_participantes"])) {
	    				...
	    				if($validar->fails()){
	    					echo '<pre>'; print_r("num participantes"); echo '</pre>';
	    				return;
	    					return redirect("/eventos/general")->with("no-validacion-2", "");
	    				}
	    			}
	    			if (!empty($datos["allDay"])) {
	    				...
	    				if($validar->fails()){
	    					echo '<pre>'; print_r("allday"); echo '</pre>';
	    				return;
	    					return redirect("/eventos/general")->with("no-validacion-2", "");
	    				}
	    			}
	    			if (!empty($datos["fecha-inicio"])) {
	    				...
	    				if($validar->fails()){
	    					echo '<pre>'; print_r("fecha inicio"); echo '</pre>';
	    				return;
	    					return redirect("/eventos/general")->with("no-validacion-2", "");
	    				}
	    			}
	    			if (!empty($datos["hora-inicio"])) {
	    				...
	    				if($validar->fails()){
	    					echo '<pre>'; print_r("hora inicio"); echo '</pre>';
	    				return;
	    					return redirect("/eventos/general")->with("no-validacion-2", "");
	    				}
	    			}
	    			if (!empty($datos["fecha-final"])) {
	    				...
	    				if($validar->fails()){
	    					echo '<pre>'; print_r("fecha final"); echo '</pre>';
	    				return;
	    					return redirect("/eventos/general")->with("no-validacion-2", "");
	    				}
	    			}
	    			if (!empty($datos["hora-final"])) {
	    				...
	    				if($validar->fails()){
	    					echo '<pre>'; print_r("hora final"); echo '</pre>';
	    				return;
	    					return redirect("/eventos/general")->with("no-validacion-2", "");
	    				}
	    			}
